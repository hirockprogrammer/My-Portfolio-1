    ...
    <main >
      <div className="">
        ...
        <section className="container-css" id="products-section">
          <h1 data-aos="fade-up" className=" text-center font-semibold text-3xl mt-5">Full Stack Projects</h1>
          <Section_2_full_stack_projects />
        </section>
        <section className="container-css" id="products-section">
          <h1 data-aos="fade-up" className=" text-center font-semibold text-3xl mt-5">Frontend Projects</h1>
